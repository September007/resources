...
{
	const DT_CHAR* string_1 = "D-Type";
	const DT_CHAR* string_2 = "ANIMATION";
	...
	Engine.CharsDoOutput(Scale(250) - X, Scale(2 * i - 20) - Y, 0, DV_SPACING_ADD_ROUND, tm, string_2);

	/* Body */
	Engine.OutputSetStyleEffects(style1);
	Engine.TypesetterSetTypeEffects(type1);
	Engine.CharsDoOutput(Scale(250) - X, Scale(700) - Y, 0, DV_SPACING_ADD_ROUND, tm, string_2);
	...
	Engine.CharsDoOutput(Scale(600) - X, Scale(i + 40) - Y, 0, DV_SPACING_ADD_ROUND, DV_NULL, string_1);

	/* Body */
	Engine.OutputSetStyleEffects(style3);
	Engine.TypesetterSetTypeEffects(type5);
	Engine.CharsDoOutput(Scale(-840 + 4 * i) - X, Scale(1480 - 3 * i) - Y, 0, DV_SPACING_ADD_ROUND, DV_NULL, string_1);
	...
	Engine.CharsDoOutput(Scale(600) - X, Scale(400) - Y, 0, DV_SPACING_ADD_ROUND, tm, string_1);
}
