...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "--------------------------------------------------\n";
	std::cout << "D-TYPE UNICODE TEXT MODULE OUTPUT DEMO\n";
	...
	std::cout << "Unicode Text Module. The text is stored in UTF-8 format in several\n";
	std::cout << "languages (English, Russian, Greek, Vietnamese, Hebrew, Arabic, Chinese).\n";
	std::cout << "\n";
