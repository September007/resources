...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "-----------------------------------------------------\n";
	std::cout << "D-TYPE UNICODE TEXT MODULE ANIMATION DEMO\n";
	std::cout << "Source File: examples/example_text_animation/main.cpp\n";
	std::cout << "-----------------------------------------------------\n";
	std::cout << "\n";
	std::cout << "This sample program shows how to render animated scalable\n";
	std::cout << "text using D-Type Unicode Text Module.\n";
	std::cout << "\n";
	std::cout << "------------------------------\n";
