...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "-------------------------------------------------------\n";
	std::cout << "D-TYPE UNICODE TEXT MODULE DEMO APPLICATION\n";
	std::cout << "Source File: examples/example_text_application/main.cpp\n";
	std::cout << "-------------------------------------------------------\n";
	std::cout << "\n";
	std::cout << "This sample program shows how to use 1) D-Type Unicode Text Module\n";
	std::cout << "to read, format and render interactive Unicode text documents and\n";
	std::cout << "2) D-Type Power Engine in conjunction with D-Type's form engine\n";
	std::cout << "helper class to render high quality and fully scalable graphical.\n";
