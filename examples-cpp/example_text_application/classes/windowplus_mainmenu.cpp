...
public:
	...
	CDTWindowPlus_MainMenu(CDTDisplay* display) : CDTWindowPlus(display, "D-Type Unicode Text Module Demo App - Main Menu", display->Dist(600), display->Dist(480), DV_WINDOW_HINT_FULLRESOLUTION),
