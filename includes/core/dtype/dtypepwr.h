...
void DTYPE_APICALL pdEngineGetDTEngineInst(DT_PDENGINE engine, DT_DTENGINE* dt_engine);
...
/* Get Engine's numeric value */
DT_SLONG DTYPE_APICALL pdEngineGetNumericValue(DT_PDENGINE engine, DT_ID_SWORD numeric_id);
/* Set Engine's numeric value */
void pdEngineSetNumericValue(DT_PDENGINE engine, DT_ID_SWORD numeric_id, DT_SLONG numeric_value);
...
void DTYPE_APICALL pdDocGetPDEngineInst(DT_PDDOC power_doc, DT_PDENGINE* engine);
...
void DTYPE_APICALL pdFlowsDump(const DT_PD_FLOWS* flows, DT_ID_SWORD frames_format, DT_SLONG img);
...
/* Get associated D-Type Standard Engine Instance */
#define pdEngineGetDTypeEngInst pdEngineGetDTEngineInst
/* Get associated Power Engine Instance */
#define pdDocGetPowerEngInst pdDocGetPDEngineInst
