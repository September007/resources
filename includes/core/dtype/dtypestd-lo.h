...
DT_STRING* DTYPE_APICALL dtStrConcatChars(DT_STRING* s, const DT_CHAR* chars, DT_SLONG len = -1);
/* String concatenate SLong */
DT_STRING* DTYPE_APICALL dtStrConcatSLong(DT_STRING* s, DT_SLONG num, DT_UWORD flags = 0);
/* String concatenate ULong */
DT_STRING* DTYPE_APICALL dtStrConcatULong(DT_STRING* s, DT_ULONG num, DT_UWORD flags = 0);
/* String concatenate Float */
DT_STRING* DTYPE_APICALL dtStrConcatFloat(DT_STRING* s, DT_FLOAT num, DT_UWORD flags = 0);
