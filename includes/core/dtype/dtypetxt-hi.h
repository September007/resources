...
/* ------------------------- D-Type Unicode Text Module (High-Level API) ------------------------- */
...
/* D-Type Unicode Text Module Functions */
...
DT_SLONG DTYPE_APICALL txTextIniViaPowerDocAndBuffer(DT_TXDOC* text_doc, DT_PDDOC power_doc, DT_SLONG nr_of_chars, const DT_UBYTE* buffer, DT_ID_SWORD buffer_format, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_DEFAULT_ATTRIBS* attribs, const DT_STREAM_DESC* fontmap_sd, DT_SWORD flags);
/* Create and initialize text document - via PowerDoc and stream */
DT_SLONG DTYPE_APICALL txTextIniViaPowerDocAndStream(DT_TXDOC* text_doc, DT_PDDOC power_doc, DT_ID_UBYTE text_type, const DT_STREAM_DESC* text_sd, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_DEFAULT_ATTRIBS* attribs, const DT_STREAM_DESC* fontmap_sd, DT_SWORD flags);
...
DT_SLONG DTYPE_APICALL txTextIniViaBuffer(DT_TXDOC* text_doc, DT_PDENGINE engine, DT_SLONG nr_of_chars, const DT_UBYTE* buffer, DT_ID_SWORD buffer_format, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_ATTRIBS text_attribs[], const DT_STREAM_DESC* fontmap_sd);
/* Create and initialize text document - via stream */
DT_SLONG DTYPE_APICALL txTextIniViaStream(DT_TXDOC* text_doc, DT_PDENGINE engine, DT_ID_UBYTE text_type, const DT_STREAM_DESC* text_sd, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_ATTRIBS text_attribs[], const DT_STREAM_DESC* fontmap_sd);
...
DT_SLONG DTYPE_APICALL txTextMakeViaPowerDocAndBuffer(DT_TXDOC text_doc, DT_PDDOC power_doc, DT_SLONG nr_of_chars, const DT_UBYTE* buffer, DT_ID_SWORD buffer_format, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_DEFAULT_ATTRIBS* attribs, const DT_STREAM_DESC* fontmap_sd, DT_SWORD flags);
/* Make text document - via PowerDoc and stream */
DT_SLONG DTYPE_APICALL txTextMakeViaPowerDocAndStream(DT_TXDOC text_doc, DT_PDDOC power_doc, DT_ID_UBYTE text_type, const DT_STREAM_DESC* text_sd, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_DEFAULT_ATTRIBS* attribs, const DT_STREAM_DESC* fontmap_sd, DT_SWORD flags);
...
DT_SLONG DTYPE_APICALL txTextMakeViaBuffer(DT_TXDOC text_doc, DT_PDENGINE engine, DT_SLONG nr_of_chars, const DT_UBYTE* buffer, DT_ID_SWORD buffer_format, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_ATTRIBS text_attribs[], const DT_STREAM_DESC* fontmap_sd);
/* Make text document - via stream */
DT_SLONG DTYPE_APICALL txTextMakeViaStream(DT_TXDOC text_doc, DT_PDENGINE engine, DT_ID_UBYTE text_type, const DT_STREAM_DESC* text_sd, DT_SWORD unicode_flags, const DT_TX_TEXTFLOW_AREA* area, const DT_TX_ATTRIBS text_attribs[], const DT_STREAM_DESC* fontmap_sd);
...
void DTYPE_APICALL txTextGetPDEngineInst(DT_TXDOC text_doc, DT_PDENGINE* engine);
...
/* Free memory allocated by the module */
void DTYPE_APICALL txFree(void* mem_addr);
/* Make cached Fontmap */
DT_SLONG DTYPE_APICALL txMakeCachedFontmap(DT_PDENGINE engine, const DT_STREAM_DESC* input_fontmap_sd, DT_STREAM_DESC* output_fontmap_sd, DT_SWORD reserved);
...
/* Backward Compatibility (up to 8.0.1.3) */

#define DT_TXENGINE DT_PDENGINE
/* Create and initialize D-Type Unicode Text Module - via stream */
#define txEngineIniViaStream pdEngineIniViaStream
/* Deinitialize and destroy D-Type Unicode Text Module */
#define txEngineExt pdEngineExt
/* Get D-Type Unicode Text Module version */
#define txEngineGetVersion pdEngineGetVersion
/* Get associated D-Type Standard Engine Instance */
#define txEngineGetDTypeEngInst pdEngineGetDTEngineInst
/* Make cached Fontmap */
#define txEngineMakeCachedFontmap txMakeCachedFontmap
/* Get associated Unicode Text Module Instance */
#define txTextGetTextEngInst txTextGetPDEngineInst
/* Get associated D-Type Power Engine Instance */
inline void txEngineGetPowerEngInst(DT_TXENGINE engine, DT_PDENGINE* pd_engine) { if (pd_engine != DV_NULL) *pd_engine = engine; }
