...
#include "dtype/dtypetxt-lo.h"  /* D-Type Unicode Text Module (Low-Level API) header */
#include "dtype/dtypetxt-hi.h"  /* D-Type Unicode Text Module (High-Level API) header */
