...
* exec/d-text and exec/d-textpro
  Contains several compiled example programs that demonstrates D-Type
  Unicode Text Module features and capabilities. Available to the users
...
* files/
  ...
  definition tables, hyphenation dictionaries for D-Type Unicode Text
